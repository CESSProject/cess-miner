...
func Tip(msg string) {
	fmt.Println(textTip(), fmt.Sprintf("%v %s", time.Now(), msg))
}

func Err(msg string) {
	fmt.Println(textErr(), fmt.Sprintf("%v %s", time.Now(), msg))
}

func Warn(msg string) {
	fmt.Println(textWarn(), fmt.Sprintf("%v %s", time.Now(), msg))
}

func Ok(msg string) {
	fmt.Println(textOk(), fmt.Sprintf("%v %s", time.Now(), msg))
}
